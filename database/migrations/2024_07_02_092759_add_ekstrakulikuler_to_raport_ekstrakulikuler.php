...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('raport_ekstrakulikuler_siswas', function (Blueprint $table) {
          ...
          //menambahkan kolom semester dari tabel "semesters" pada tbl raport_ekstrakuloikuler sebagai foreignKey
            ...
            //menambahkan kolom ekstrakulikuler dari tabel "extrakulikulers" pada tbl raport_ekstrakuloikuler sebagai foreignKey
            $table->unsignedBigInteger('id_ekstrakulikuler')->after('id')->required();
    ...
    public function down(): void
    {
        Schema::table('raport_ekstrakulikuler_siswas', function (Blueprint $table) {
            ...
            $table->dropColumn('id_ekstrakulikuler');
        });
    }
};
