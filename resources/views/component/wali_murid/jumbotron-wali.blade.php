        ...
        <div id="carousel" class="flex transition-transform duration-500 ease-in-out w-full h-full">
            ...
            <div class="relative w-full h-full min-w-full flex items-center justify-center">
                ...
                <div class="relative px-4 mx-auto max-w-screen-xl text-center py-12 lg:py-28">
                    ...
                    <p class="mb-8 text-lg font-normal text-gray-300 lg:text-xl sm:px-16 lg:px-48">Selamat kepada {{$item->siswa->nama_lengkap}}{{$item->ket}} pada tanggal "{{$item->date}}"</p>
                    <div class="flex flex-col space-y-4 sm:flex-row sm:justify-center sm:space-y-0">
                        <a href="{{ route('prestasi.index.wali') }}" class="inline-flex justify-center hover:text-gray-900 items-center py-3 px-5 text-base font-medium text-center text-white rounded-lg border border-white hover:bg-gray-100 focus:ring-4 focus:ring-gray-400">Learn more</a>
                    </div>
                </div>
            </div>
            @endforeach
