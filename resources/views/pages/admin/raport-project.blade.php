    ...
    <div class="flex flex-col justify-center">
        <div class="mx-auto max-w-screen-xl p-4 sm:px-6 lg:px-8">
            <header class="text-center">
                <h2 class="text-4xl font-extrabold text-gray-900 md:text-5xl lg:text-6xl">Data Raport MBKM</h2>
        ...
        <form id="filter-form" method="GET" action="{{ route('index.raport.mbkm') }}">
            @csrf
                        ...
                        <tbody>
                            ...
                            @foreach ($siswas as $item)
                                <tr class="bg-white border dark:bg-white">
                                    ...
                                    <td class="px-6 py-4">
                                        @include('component.admin.btn_mbkm')
                                    </td>
                                </tr>  
                            @endforeach
                        </tbody>
